...
public class UploadPanel extends JPanel implements DropTargetListener {
	...
	public UploadPanel(String username, ChatRoomFrame chatRoomFrame,
			JoyuClientSocket joyuClientSocket, String systemInfo,
			GridLayout gridlayout, String SayuServerIP, String SayuServerport) {
		super(gridlayout);
