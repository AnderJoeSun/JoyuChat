...
public class RButtonPanelPain extends JButton {
	...
	public static final Color MYFG = new Color(51, 184, 47);
	...
	public RButtonPanelPain() {
		this(ROUND_RECT);
	}

	public RButtonPanelPain(int style) {
		this.style = style;
		if (BALL == style) {
	...
	public RButtonPanelPain(int style, String text) {
		setText(text);
		this.style = style;
		if (BALL == style) {
			setPreferredSize(new Dimension(42, 42));
