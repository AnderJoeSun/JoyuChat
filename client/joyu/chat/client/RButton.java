...
public class RButton extends JButton {
	...
	public static final Color BUTTON_COLOR1 = new Color(200, 254, 147);
	// public static final Color BUTTON_COLOR2 =new Color(183, 184, 80);
	// public static final Color BUTTON_COLOR3 =new Color(200, 254, 147);
	...
	public static final Color BUTTON_FOREGROUND_COLOR = Color.DARK_GRAY;
	...
	public RButton(int style, String text) {
		setText(text);
		this.style = style;
		if (BALL == style) {
			setPreferredSize(new Dimension(42, 42));
